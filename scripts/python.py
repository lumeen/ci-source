...
headers = {'content-type':'multipart/form-data; boundary=--------------------------461086193928633743539511','content-type': 'multipart/form-data; boundary=----WebKitFormBoundary7MA4YWxkTrZu0gW','Authorization': token, 'X-ANYPNT-ENV-ID': '2b38afe9-1e88-411e-82d7-b9376cfab625'}
